...
class ListaAnimalesWidget extends StatefulWidget {
  const ListaAnimalesWidget({
    super.key,
    this.proyectId,
    this.proyectName,
    this.proyectProduction,
    this.proyectCity,
    this.proyectType,
    this.proyectValue,
    this.proyectStatus,
  ...
  final String? proyectProduction;
  final String? proyectCity;
  final String? proyectType;
  final double? proyectValue;
  final StatusProyect? proyectStatus;
  final String? proyectDescription;
  final String? proyectImage;
  final String? productionTime;
  final LatLng? location;
  final DateTime? createTime;
  final DocumentReference? proyectManager;

  @override
  State<ListaAnimalesWidget> createState() => _ListaAnimalesWidgetState();
}
