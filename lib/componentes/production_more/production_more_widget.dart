...
class ProductionMoreWidget extends StatefulWidget {
  const ProductionMoreWidget({
    super.key,
    this.proyectName,
    this.proyectId,
    this.userName,
  ...
  @override
  State<ProductionMoreWidget> createState() => _ProductionMoreWidgetState();
}

class _ProductionMoreWidgetState extends State<ProductionMoreWidget> {
  late ProductionMoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductionMoreModel());
