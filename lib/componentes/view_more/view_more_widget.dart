...
class ViewMoreWidget extends StatefulWidget {
  ...
  final String? productionMeasure;
  final StatusProyect? statusProyect;
    ...
    return Container(
      ...
      child: StreamBuilder<List<AnimalesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<AnimalesRecord> listViewAnimalesRecordList = snapshot.data!;
                          ...
                          children: [
                            Align(
                              ...
                              child: CarruselWidget(
                                ...
                                imgList: listViewAnimalesRecord.imgList,
                              ),
                            ),
                            Padding(
