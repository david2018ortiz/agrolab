...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/listaAnimales',
          requireAuth: true,
          builder: (context, params) => ListaAnimalesWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['proyects'],
            ),
            proyectName: params.getParam(
              'proyectName',
              ParamType.String,
            ),
            proyectProduction: params.getParam(
              'proyectProduction',
              ParamType.String,
            ),
            proyectCity: params.getParam(
              'proyectCity',
              ParamType.String,
            ),
            proyectType: params.getParam(
              'proyectType',
              ParamType.String,
            ),
            proyectValue: params.getParam(
              'proyectValue',
              ParamType.double,
            ),
            proyectStatus: params.getParam<StatusProyect>(
              'proyectStatus',
              ParamType.Enum,
            ),
            proyectDescription: params.getParam(
              'proyectDescription',
              ParamType.String,
            ),
            proyectImage: params.getParam(
              'proyectImage',
              ParamType.String,
            ),
            productionTime: params.getParam(
              'productionTime',
              ParamType.String,
            ),
            ...
            proyectManager: params.getParam(
              'proyectManager',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: '/expenses',
          requireAuth: true,
          builder: (context, params) => ExpensesWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => AgregarProduccionWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: '/agregarGastos',
          requireAuth: true,
          builder: (context, params) => AgregarGastosWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => ProductionManagerWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => ExpensesManagerWidget(
            proyectId: params.getParam(
              'proyectId',
              ParamType.DocumentReference,
              isList: false,
