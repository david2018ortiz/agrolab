...
class ExpensesMoreManagerWidget extends StatefulWidget {
  const ExpensesMoreManagerWidget({
    super.key,
    this.proyectName,
    this.proyectId,
    this.userName,
  ...
  @override
  State<ExpensesMoreManagerWidget> createState() =>
      _ExpensesMoreManagerWidgetState();
}

class _ExpensesMoreManagerWidgetState extends State<ExpensesMoreManagerWidget> {
  late ExpensesMoreManagerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExpensesMoreManagerModel());
