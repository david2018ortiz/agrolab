...
import '/componentes_manager/production_more_manager/production_more_manager_widget.dart';
...
class ProductionManagerWidget extends StatefulWidget {
  const ProductionManagerWidget({
    super.key,
    this.proyectId,
    this.proyectName,
  });
  ...
  @override
  State<ProductionManagerWidget> createState() =>
      _ProductionManagerWidgetState();
}

class _ProductionManagerWidgetState extends State<ProductionManagerWidget> {
  late ProductionManagerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductionManagerModel());
