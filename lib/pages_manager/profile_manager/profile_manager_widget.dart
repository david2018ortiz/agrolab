...
class _ProfileManagerWidgetState extends State<ProfileManagerWidget> {
  ...
  void initState() {
    ...
    _model.identidadTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.document, ''));
    _model.identidadFocusNode ??= FocusNode();
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      ...
                      focusNode: _model.identidadFocusNode,
                      textCapitalization: TextCapitalization.words,
                      readOnly: _model.editar,
                      obscureText: false,
                      decoration: InputDecoration(
                      ...
                      validator: _model.identidadTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                            ...
                            document: _model.identidadTextController.text,
                            userRol: UserRol.granjero,
